...
export default function FAQPage() {
  ...
  const faqItems: FAQItem[] = [
    ...
    {
      category: 'Getting Started',
      question: `Is ${name} legal in my country?`,
      answer: `${name} operates under a Curacao eGaming license. However, online gambling laws vary by jurisdiction. It is your responsibility to ensure that using ${name} is legal in your location. We restrict access from certain jurisdictions where online gambling is prohibited.`,
    },
    {
      category: 'Getting Started',
    ...
    },
    {
      ...
      answer: 'Minimum deposit: $10 equivalent in any supported cryptocurrency. Minimum withdrawal: $20 equivalent. Maximum withdrawal depends on your VIP level, ranging from $5,000/day (Bronze) to unlimited (Iron).',
    },
    {
      category: 'Deposits & Withdrawals',
    ...
    // VIP & Bonuses
    {
      ...
      answer: 'Your VIP level is determined by your total wagered amount. As you play, you automatically progress through 6 tiers: Bronze, Silver, Gold, Platinum, Diamond, and Iron. Each tier unlocks better rakeback, higher withdrawal limits, exclusive bonuses, and premium perks.',
    },
    {
      category: 'VIP & Bonuses',
    ...
    <MainLayout>
      <div className="p-4 lg:p-8 max-w-4xl mx-auto space-y-6" data-testid="faq-page">
        ...
        <div className="bg-bg-card border border-white/10 rounded-2xl p-8 text-center">
          ...
          <p className="text-text-secondary">Find answers to the most common questions about {name}.</p>
        </div>
