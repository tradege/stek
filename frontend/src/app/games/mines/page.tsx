  ...
  return (
    <div className="min-h-screen bg-bg-primary flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className={`max-w-md w-full text-center relative z-10 ${mounted ? 'animate-fade-in-scale' : 'opacity-0'}`}>
        ...
        <div className="w-32 h-32 mx-auto mb-8 rounded-3xl bg-gradient-to-br from-red-600 via-rose-600 to-pink-600 flex items-center justify-center shadow-2xl animate-coming-soon-float animate-coming-soon-glow">
          <span className="text-6xl animate-icon-bounce">💣</span>
        </div>

        {/* Title with shimmer */}
        <h1 className="text-4xl font-bold text-white mb-4 text-shimmer">Mines</h1>
        ...
        <p className="text-gray-400 mb-8 animate-fade-in" style={{ animationDelay: '0.3s' }}>
          Navigate through the minefield! Reveal gems to increase your multiplier, but avoid the bombs!
        </p>

        {/* Features list */}
        <div className="grid grid-cols-2 gap-3 mb-8">
          {['Customizable Grid', 'Cash Out Anytime', 'High Multipliers', 'Strategy Game'].map((feature, i) => (
            <div
              key={feature}
