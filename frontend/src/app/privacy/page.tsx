...
export default function PrivacyPage() {
  ...
  const sections = [
    ...
    },
    {
      ...
      content: `If you are located in the European Economic Area, you have the following rights: (a) Right to access your personal data; (b) Right to rectification of inaccurate data; (c) Right to erasure ("right to be forgotten"); (d) Right to restrict processing; (e) Right to data portability; (f) Right to object to processing; (g) Right to withdraw consent at any time. To exercise these rights, contact our Data Protection Officer at ${privacyEmail}. We will respond within 30 days.`,
    },
    {
      title: '7. Cookies',
    ...
    {
      title: '11. Contact Us',
      content: `For questions about this Privacy Policy or to exercise your data rights, contact us at: Email: ${privacyEmail}. Data Protection Officer: ${dpoEmail}. You also have the right to lodge a complaint with your local data protection authority.`,
    },
  ];
      ...
      <div className="p-4 lg:p-8 max-w-4xl mx-auto space-y-6" data-testid="privacy-page">
        ...
        <div className="bg-bg-card border border-white/10 rounded-xl p-6">
          <p className="text-text-secondary text-sm leading-relaxed">
            {name} (&quot;we&quot;, &quot;us&quot;, or &quot;our&quot;) is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our platform. Please read this policy carefully. By using {name}, you consent to the data practices described in this policy.
          </p>
        </div>
