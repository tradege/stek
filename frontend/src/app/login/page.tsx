      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="card p-8">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-card text-text-tertiary">or continue with</span>
            </div>
          </div>

          {/* Social Login */}
          <div className="grid grid-cols-2 gap-3">
            <button className="btn-ghost py-2 flex items-center justify-center gap-2">
        ...
        <div className="mt-4 p-3 bg-card-hover rounded-lg text-center">
          <p className="text-xs text-text-tertiary">
            Demo Account: <span className="text-text-secondary">demo@stakepro.com</span> / <span className="text-text-secondary">demo1234</span>
          </p>
        </div>
      </div>
    </div>
