  ...
  const sections = [
    {
      ...
      content: `By accessing or using ${name} ("the Platform"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, you must not access or use the Platform. These Terms constitute a legally binding agreement between you and ${name}.`,
    },
    {
      title: '2. Eligibility',
    ...
    },
    {
      ...
      content: `${name} is provided "as is" without warranties of any kind. To the maximum extent permitted by law, ${name} shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of the Platform. ${name}'s total liability shall not exceed the amount of funds in your account at the time of the claim. ${name} is not responsible for losses due to blockchain network issues, wallet errors, or third-party service failures.`,
    },
    {
      title: '10. Dispute Resolution',
      content: `Any disputes arising from these Terms or your use of the Platform shall first be resolved through ${name}'s internal complaint procedure. If the dispute cannot be resolved internally within 30 days, it shall be submitted to binding arbitration. The arbitration shall be conducted in accordance with the rules of the applicable arbitration body. The language of arbitration shall be English.`,
    },
    {
      title: '11. Modifications',
      content: `${name} reserves the right to modify these Terms at any time. Changes will be effective immediately upon posting on the Platform. Your continued use of the Platform after changes constitutes acceptance of the modified Terms. We encourage you to review these Terms periodically.`,
    },
    {
      title: '12. Contact',
      content: `For questions about these Terms, please contact our support team via the live chat feature on the Platform or email ${email}.`,
    },
  ];
